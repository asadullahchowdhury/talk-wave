<template>
  <div class="messenger">
    <div class="row">
      ...
      <!--Inbox content start-->
      <div class="" :class="details === true ? 'col-xxl-9 col-xl-8 col-md-7' : 'col-12'">
        <div class="messenger-inner shadow rounded-5 bg-light p-0">
          ...
          <div class="inbox-header d-flex justify-content-between rounded-top-5 py-4 px-3 align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
              <router-link :to="{name:'InboxDashboard'}" class="btn">
            ...
            <div class="actions d-flex align-items-center gap-3">
              <a href="javascript:void(0)" @click="showDetails"
                 class="btn rounded-circle d-md-flex d-none justify-content-center align-items-center">
